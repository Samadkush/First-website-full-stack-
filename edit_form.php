...
if (isset($_GET['form_id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        updateFormData($formId, $updatedStudyDescription, $updatedExplainData, $updatedStudyResult, $updatedyesno1, $updatedStudyDescription1, $updatedyesno2, $updatedStudyDescription2, $updatedStudyResult1, $updatedyesno3, $updatedStudyDescription3, $updatedName, $updatedResearcherSignature, $updatedName1, $updatedSupervisorSignature);
...
function updateFormData($formId, $updatedStudyDescription, $updatedExplainData, $updatedStudyResult, $updatedyesno1, $updatedStudyDescription1, $updatedyesno2, $updatedStudyDescription2, $updatedStudyResult1, $updatedyesno3, $updatedStudyDescription3, $updatedName, $updatedResearcherSignature, $updatedName1, $updatedSupervisorSignature) {
    $conn = connectToDatabase();

    // Prepare and execute a query to update the form data
    $stmt = $conn->prepare("UPDATE projectApplications SET StudyDescription = ?, ExplainData = ?, StudyResult = ?, yesno1 =?, StudyDescription_1 = ?, yesno2 =?, StudyDescription_2 = ?, StudyResult_1 = ?, yesno3 = ?, StudyDescription_3 = ?, Name = ?, ResearcherSignature = ?, Name_1 = ?, SupervisorSignature = ? WHERE form_id = ?");
    $stmt->bind_param("ssssssssssssssi", $updatedStudyDescription, $updatedExplainData, $updatedStudyResult, $updatedyesno1, $updatedStudyDescription1, $updatedyesno2, $updatedStudyDescription2, $updatedStudyResult1, $updatedyesno3, $updatedStudyDescription3, $updatedName, $updatedResearcherSignature, $updatedName1, $updatedSupervisorSignature, $formId);
    $stmt->execute();
header('Location: dashboard.php');
exit();
}
...
<body>
<button id="backButton" class="back-button">Back to Application Status</button>


    <h1>ETHICS COMMITTEE PROJECT INFORMATION FORM</h1>
    <form action="edit_form.php?form_id=<?php echo $formId; ?>" method="post">
        ...
        <p class="center-align">
            <textarea name="StudyDescription" rows="8"
                cols="50"><?php echo isset($formData['StudyDescription']) ? htmlspecialchars($formData['StudyDescription']) : ''; ?></textarea>
        </p>
        ...
        <p class="center-align">
            <textarea name="ExplainData" rows="8"
                cols="50"><?php echo isset($formData['ExplainData']) ? htmlspecialchars($formData['ExplainData']) : ''; ?></textarea>
        </p>
        <label for="StudyTitle" class="center-align">3. Write down the expected results of your study.</label>
        <p class="center-align">
            <textarea name="StudyResult" rows="8"
                cols="50"><?php echo isset($formData['StudyResult']) ? htmlspecialchars($formData['StudyResult']) : ''; ?></textarea>
        </p>
        ...
        <input type="radio" name="yesno1" value="yes"
            onclick="toggleInputBox(true, 'inputBoxContainer1')" <?php if (isset($formData['yesno1']) && $formData['yesno1'] === 'yes') echo 'checked'; ?>> Yes
        <input type="radio" name="yesno1" value="no"
            onclick="toggleInputBox(false, 'inputBoxContainer1')" <?php if (isset($formData['yesno1']) && $formData['yesno1'] === 'no') echo 'checked'; ?>> No
        <div id="inputBoxContainer1" style="display: <?php echo isset($formData['yesno1']) && $formData['yesno1'] === 'yes' ? 'block' : 'none'; ?>;">
            <textarea name="StudyDescription_1" rows="8"
                cols="50"><?php echo isset($formData['StudyDescription_1']) ? htmlspecialchars($formData['StudyDescription_1']) : ''; ?></textarea>
        </div>
        <!-- YES_NO2 -->
        <label for="StudyTitle" class="center-align">
        ...
        <br>
        <input type="radio" name="yesno2" value="yes"
            onclick="toggleInputBox(true, 'inputBoxContainer2')" <?php if (isset($formData['yesno2']) && $formData['yesno2'] === 'yes') echo 'checked'; ?>> Yes
        <input type="radio" name="yesno2" value="no"
            onclick="toggleInputBox(false, 'inputBoxContainer2')" <?php if (isset($formData['yesno2']) && $formData['yesno2'] === 'no') echo 'checked'; ?>> No
        <div id="inputBoxContainer2" style="display: <?php echo isset($formData['yesno2']) && $formData['yesno2'] === 'yes' ? 'block' : 'none'; ?>;">
            <textarea name="StudyDescription_2" rows="8"
                cols="50"><?php echo isset($formData['StudyDescription_2']) ? htmlspecialchars($formData['StudyDescription_2']) : ''; ?></textarea>
        </div>
        ...
        <p class="center-align">
            <textarea name="StudyResult_1" rows="8"
                cols="50"><?php echo isset($formData['StudyResult_1']) ? htmlspecialchars($formData['StudyResult_1']) : ''; ?></textarea>
        </p>
        <!-- YES_NO3 -->
        <label for="StudyTitle" class="center-align">
        ...
        <br>
        <input type="radio" name="yesno3" value="yes"
            onclick="toggleInputBox(true, 'inputBoxContainer3')" <?php if (isset($formData['yesno3']) && $formData['yesno3'] === 'yes') echo 'checked'; ?>> Yes
        <input type="radio" name="yesno3" value="no"
            onclick="toggleInputBox(false, 'inputBoxContainer3')" <?php if (isset($formData['yesno3']) && $formData['yesno3'] === 'no') echo 'checked'; ?>> No
        <div id="inputBoxContainer3" style="display: <?php echo isset($formData['yesno3']) && $formData['yesno3'] === 'yes' ? 'block' : 'none'; ?>;">
            <textarea name="StudyDescription_3" rows="8"
                cols="50"><?php echo isset($formData['StudyDescription_3']) ? htmlspecialchars($formData['StudyDescription_3']) : ''; ?></textarea>
        </div>
        ...
        <p>
            ...
            <input type="text" class="new" size="60" name="Name_1"
                value="<?php echo isset($formData['Name_1']) ? htmlspecialchars($formData['Name_1']) : ''; ?>">
